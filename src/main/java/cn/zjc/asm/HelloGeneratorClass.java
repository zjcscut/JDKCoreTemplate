...
public class HelloGeneratorClass implements Opcodes {
    ...
    public static byte[] generatorHelloClass() throws Exception {
        ...
        writer.visit(V1_8, ACC_PUBLIC + ACC_SUPER, "cn/zjc/asm/Hello", null, "java/lang/Object", null);
        writer.visitSource("Hello.java", null);

        {
            fv = writer.visitField(ACC_PUBLIC + ACC_FINAL + ACC_STATIC, "FLAG", "Ljava/lang/String;", null, "\\u6211\\u662f\\u5e38\\u91cf");
            fv.visitEnd();
        }
        ...
        {
            mv = writer.visitMethod(ACC_PUBLIC, "display", "()V", null, null);
            mv.visitCode();
            Label l0 = new Label();
            mv.visitLabel(l0);
        ...
        {
            mv = writer.visitMethod(ACC_PUBLIC, "testList", "()Ljava/util/List;", "()Ljava/util/List<Ljava/lang/String;>;",
                    null);
            mv.visitCode();
            Label l0 = new Label();
            mv.visitLabel(l0);
        ...
        {
            mv = writer.visitMethod(ACC_PUBLIC + ACC_VARARGS, "testMapList", "(Z[Ljava/util/Map;)Ljava/util/List;",
            ...
            mv.visitFrame(Opcodes.F_FULL, 8,
                    new Object[]{"cn/zjc/asm/Hello", Opcodes.INTEGER, "[Ljava/util/Map;",
            ...
            mv.visitLabel(l2);
            mv.visitFrame(Opcodes.F_FULL, 4, new Object[]{"cn/zjc/asm/Hello", Opcodes.INTEGER,
    ...
    public static void main(String[] args) throws Exception {
        try {
            ...
            File file = new File("D:/Develop/Projects/JDKCoreTemplate"  + "/out/Hello.class");
            if (!file.exists()){
        ...
        try {
            ...
            Class<?> helloClass = myClassLoader.loadClass("cn.zjc.asm.Hello", data);
